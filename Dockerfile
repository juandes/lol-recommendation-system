...
COPY --from=0 /go/src/github.com/juandes/knn-recommender-system/static/champions_key.json /data/
COPY --from=0 /go/src/github.com/juandes/knn-recommender-system/static/winning_teams.csv /data/
